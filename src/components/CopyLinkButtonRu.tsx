...
export function OdnoklassnikiIcon(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M12 0a6.2 6.2 0 0 0-6.194 6.195a6.2 6.2 0 0 0 6.195 6.192a6.2 6.2 0 0 0 6.193-6.192A6.2 6.2 0 0 0 12.001 0zm0 3.63a2.567 2.567 0 0 1 2.565 2.565a2.57 2.57 0 0 1-2.564 2.564a2.57 2.57 0 0 1-2.565-2.564a2.567 2.567 0 0 1 2.565-2.564zM6.807 12.6a1.814 1.814 0 0 0-.91 3.35a11.6 11.6 0 0 0 3.597 1.49l-3.462 3.463a1.815 1.815 0 0 0 2.567 2.566L12 20.066l3.405 3.403a1.813 1.813 0 0 0 2.564 0c.71-.709.71-1.858 0-2.566l-3.462-3.462a11.6 11.6 0 0 0 3.596-1.49a1.814 1.814 0 1 0-1.932-3.073a7.87 7.87 0 0 1-8.34 0c-.318-.2-.674-.29-1.024-.278"></path></svg>);
}
...
export function MailGunIcon(props: SVGProps<SVGSVGElement>) {
	return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}><defs><path id="tablerBrandMailgun0" d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0-2 0"></path></defs><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}><path d="M17 12a2 2 0 1 0 4 0a9 9 0 1 0-2.987 6.697"></path><path d="M7 12a5 5 0 1 0 10 0a5 5 0 1 0-10 0"></path><use href="#tablerBrandMailgun0"></use><use href="#tablerBrandMailgun0"></use></g></svg>);
}
      ...
      {showMenu && (
        ...
        >
          ...
          <a href={`viber://forward?text=https://${window.location.host}&text=Резюме – ${RESUME_DATA_RU.name} | Инженер-проектировщик АСУ ТП`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            ...
            <span className="whitespace-nowrap">Viber</span>
          </a>
          <a href={`https://vk.com/share.php?url=https://${window.location.host}&title=Резюме – ${RESUME_DATA_RU.name} | Инженер-проектировщик АСУ ТП`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            ...
            <span className="whitespace-nowrap">ВКонтакте</span>
          </a>   
          <a href={`https://connect.mail.ru/share?url=https://${window.location.host}&title=Резюме – ${RESUME_DATA_RU.name} | Инженер-проектировщик АСУ ТП`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <MailGunIcon className="w-4 h-4" />
            <span className="whitespace-nowrap">Мой Мир</span>
          </a>   
          <a href={`https://connect.ok.ru/offer?url=https://${window.location.host}/&title=Резюме — ${RESUME_DATA_RU.name} — Инженер-проектировщик АСУ ТП`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <OdnoklassnikiIcon className="w-4 h-4" />
            <span className="whitespace-nowrap">Одноклассники</span>
          </a>
          <a href={`https://yandex.ru/chat?text=https://${window.location.host}%0AРезюме – ${RESUME_DATA_RU.name} | Инженер-проектировщик АСУ ТП#/forward`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <YandexMessengerIcon className="w-4 h-4" />
            <span className="whitespace-nowrap">Яндекс.Мессенджер</span>
          </a>
          <a href={`https://www.evernote.com/clip.action?title=Резюме – ${RESUME_DATA_RU.name} – Инженер-проектировщик АСУ ТП&url=https://${window.location.host}`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <EvernoteIcon className="w-4 h-4" />
            <span className="whitespace-nowrap">Evernote</span>
          </a>
          <a onClick={copyToClipboard} className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <Copy className="w-4 h-4" />
            <span className="whitespace-nowrap">Скопировать ссылку</span>
          </a>
        </div>
      )}
