    ...
    >
      ...
      {showMenu && (
        ...
        >
          ...
          <a href={`mailto:?subject=Resume Denis Dmitrievich Minishin - Design Engineer, Process Control Engineer&body=Denis Dmitrievich Minishin - Design Engineer, Process Control Engineer%0A%0Ahttps://${window.location.host} – Resume%0Ahttps://${window.location.host}/#portfolio – Portfolio`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <EmailIcon className="w-5 h-5" />
            <span className="whitespace-nowrap text-base">E-mail</span>
          </a>
          <a href={`https://t.me/share/url?url=https://${window.location.host}&text=${RESUME_DATA_EN.name} – Design Engineer, Process Control Engineer`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <TelegramIcon className="w-5 h-5" />
            <span className="whitespace-nowrap text-base">Telegram</span>
          </a>
          <a href={`https://api.whatsapp.com/send?text=Resume Denis Dmitrievich Minishin – https://${window.location.host}`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <WhatsappIcon className="w-5 h-5" />
            <span className="whitespace-nowrap text-base">WhatsApp</span>
          </a>
          <a href={`viber://forward?text=https://${window.location.host}&text=Resume – ${RESUME_DATA_EN.name} | Design Engineer, Process Control Engineer`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <ViberIcon className="w-5 h-5" />
            <span className="whitespace-nowrap text-base">Viber</span>
          </a>
          <a href={`https://vk.com/share.php?url=https://${window.location.host}&title=Resume – ${RESUME_DATA_EN.name} | Design Engineer, Process Control Engineer`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
            <VkIcon className="w-5 h-5" />
            <span className="whitespace-nowrap text-base">VK</span>
          </a>
          <a href={`https://yandex.ru/chat?text=https://${window.location.host}%0AResume – ${RESUME_DATA_EN.name} | Design Engineer, Process Control Engineer#/forward`} target="_blank" className="flex items-center space-x-2 hover:bg-gray-700 px-2 py-1 rounded cursor-pointer">
